...
namespace AssetDanshari
{
    public class AssetDanshariWindow : EditorWindow
    {
        ...
        private int m_ReorderableEditIndex;
        ...
        private void Init()
        {
            ...
            if (m_ReorderableList == null)
            {
                ...
                m_ReorderableList.elementHeight += 37;
            }
            m_ReorderableEditIndex = -1;
        }
        ...
        private void OnDrawElementCallback(Rect rect, int index, bool isactive, bool isfocused)
        {
            ...
            Rect rect2 = new Rect(rect) { width = 75f };
            ...
            {
                AssetDuplicateWindow.CheckPaths(GetPaths(info.assetFolder));
            }
